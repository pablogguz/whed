...
#'   \item{business_school}{Indicates if the institution has a business school}
#'   \item{degree_count}{Number of degrees offered}
#'   \item{division_name_X}{Name of division X}
#'   \item{division_fields_study_X}{Fields of study in division X}
